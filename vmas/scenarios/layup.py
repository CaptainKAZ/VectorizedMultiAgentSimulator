...
class Scenario(BaseScenario):
    ...
    def make_world(self, batch_dim: int, device: torch.device, **kwargs):
        ...
        self.h_params["k_repulsion_reward"] = kwargs.get("k_repulsion_reward", 3.0)
        ...
        self.h_params["k_timeout_move_vel_penalty"] = kwargs.get("k_timeout_move_vel_penalty", 200.0)
        self.h_params["k_timeout_move_act_penalty"] = kwargs.get("k_timeout_move_act_penalty", 300.0)
